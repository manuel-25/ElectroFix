...
const Services = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch('http://localhost:5000/api/service-requests', { //http://localhost:5000/api/service-requests  https://electrosafeweb.com/api/service-requests 
        method: 'POST',
        headers: {
