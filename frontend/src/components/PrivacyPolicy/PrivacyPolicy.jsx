  ...
  return (
    <div className="privacy-container">
      ...
      <div className="section">
        ...
        <p className="normal-text">
          En caso que el Usuario tenga alguna duda acerca de la Política de Privacidad, o sobre la aplicación de la misma, deberá ponerse en contacto con Electrosafe, en cualquier momento, vía correo electrónico a <a href="mailto:electrosafequilmes@gmail.com">electrosafequilmes@gmail.com</a>. Electrosafe, CUIT 30-12345678-9, CON DOMICILIO EN Av. Libertador 1234, Ciudad de Buenos Aires, Argentina.
        </p>
      </div>
    </div>
  )
