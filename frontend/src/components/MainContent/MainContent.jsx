...
function MainContent() {
    ...
    function handleScroll() {
        const elements = document.querySelectorAll('.vertical-animation, .horizontal-animation')
    ...
    useEffect(() => {
        ...
        // Simular la carga de los elementos
        const timer = setTimeout(() => setLoading(false), 1000) // Ajusta el tiempo de espera según sea necesario
