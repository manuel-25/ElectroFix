      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background-color: #F5F7FA; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <div style="background-color: white; padding: 20px; border-radius: 0 0 10px 10px;">
          ...
          <p style="text-align: center; margin-top: 20px;">
            <a href="https://wa.me/549${userData.phone}?text=Hola, ${userData.firstName}! te escribo desde Electrosafe ví tu cotizacioón en nuestra web y quería comentarte las opciones y promociones que tenemos para reparación de tu ${category.name}." 
